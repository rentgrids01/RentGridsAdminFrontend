export const getFileExtensionIcon = fileName => {
  ...
  if (extension === 'fig') return 'bxl:figma';else if (extension === 'docs') return 'iconamoon:file-light';else if (extension === 'zip') return 'ri:file-2-fill';else if (extension === 'pdf') return 'bxs:file-pdf';else if (extension === 'jpg') return 'bx-images';else if (extension === 'png') return 'bx-images';else if (extension === 'jpeg') return 'bx-images';else return 'bxs:file';
};
